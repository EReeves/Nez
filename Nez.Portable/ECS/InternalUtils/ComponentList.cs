...
namespace Nez.ECS.InternalUtils
{
    public class ComponentList
    {
        ...
        private static readonly UpdatableComparer CompareUpdatableOrder = new UpdatableComparer();

	    /// <summary>
	    ///     list of components added to the entity
	    /// </summary>
	    private readonly FastList<Component> _components = new FastList<Component>();

	    /// <summary>
	    ///     The list of components that were added this frame. Used to group the components so we can process them
	    ///     simultaneously
	    /// </summary>
	    internal List<Component> ComponentsToAdd = new List<Component>();
        ...
        private readonly List<Component> _tempBufferList = new List<Component>();

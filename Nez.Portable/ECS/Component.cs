...
namespace Nez.ECS
{
	...
	public class Component : IComparable<Component>
	{
	    ...
	    /// <summary>
	    ///     creates a clone of this Component. The default implementation is just a MemberwiseClone so if a Component has
	    ///     object references
	    ...
	    /// <summary>
	    ///     called when this Component has had its Entity assigned but it is NOT yet added to the live Components list of the
	    ///     Entity yet. Useful
	    ...
	    /// <summary>
	    ///     Called when this component is added to a scene after all pending component changes are committed. At this point,
	    ///     the entity field
	    ...
	    /// <summary>
	    ///     called when the entity's position changes. This allows components to be aware that they have moved due to the
	    ///     parent
	    ///     entity moving.
	    /// </summary>

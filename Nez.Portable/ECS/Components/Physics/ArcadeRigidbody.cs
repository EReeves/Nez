...
namespace Nez
{
	...
	public class ArcadeRigidbody : Component, IUpdatable
    {
	    ...
	    /// <summary>
	    ///     0 - 9 range. When a collision occurs and it has risidual motion along the surface of collision if its square
	    ///     magnitude is less
	    ...
	    /// <summary>
	    ///     rigidbodies with a mass of 0 are considered immovable. Changing velocity and collisions will have no effect on
	    ///     them.
	    /// </summary>
	    ...
	    /// <summary>
	    ///     add an instant force impulse to the rigidbody using its mass. force is an acceleration in pixels per second per
	    ///     second. The
	    ...
	    private void ProcessOverlap(ArcadeRigidbody other, ref Vector2 minimumTranslationVector)
        {
            if (IsImmovable)
            {
	    ...
	    /// <summary>
	    ///     handles the collision of two non-overlapping rigidbodies. New velocities will be assigned to each rigidbody as
	    ///     appropriate.
	    /// </summary>
	    /// <param name="other">Other.</param>
	    /// <param name="inverseMTV">Inverse MT.</param>
	    private void ProcessCollision(ArcadeRigidbody other, ref Vector2 minimumTranslationVector)
        {
	    ...
	    /// <summary>
	    ///     given the relative velocity between the two objects and the MTV this method modifies the relativeVelocity to make
	    ///     it a collision
	    ///     response.
	    /// </summary>
	    /// <param name="relativeVelocity">Relative velocity.</param>
	    /// <param name="minimumTranslationVector">Minimum translation vector.</param>
	    private void CalculateResponseVelocity(ref Vector2 relativeVelocity, ref Vector2 minimumTranslationVector,

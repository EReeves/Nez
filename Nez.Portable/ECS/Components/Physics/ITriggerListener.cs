namespace Nez
{
	...
	///     called.
	///     The ITriggerListener method will be called on any Component on the Entity that is a trigger that implement the
	///     interface.
    ...
    {
	    /// <summary>
	    ///     called when a collider intersects a trigger collider. This is called on the trigger collider and the collider that
	    ///     touched

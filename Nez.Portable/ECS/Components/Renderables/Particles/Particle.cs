...
namespace Nez.ECS.Components.Renderables.Particles
{
	...
	public class Particle
    {
	    ...
	    /// </summary>
	    private static readonly Circle CircleCollisionShape = new Circle(0);
        ...
        private float _particleSizeDelta;
        private float _radialAcceleration;
            ...
            if (_timeToLive > 0)
            {
                ...
                if (collisionConfig.Enabled)
                {
                    ...
                    foreach (var neighbor in neighbors)
                    {
                        ...
                        if (CircleCollisionShape.CollidesWithShape(neighbor.Shape, out result))
                        {
                            // handle the overlap
	    ...
	    private void CalculateCollisionResponseVelocity(float friction, float elasticity,
            ref Vector2 minimumTranslationVector)
        {

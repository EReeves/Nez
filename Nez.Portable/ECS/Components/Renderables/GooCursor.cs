...
namespace Nez
{
	...
	public class GooCursor : RenderableComponent, IUpdatable
    {
        ...
        private readonly int _trailNodeCount;
        private readonly TrailNode[] _trailNodes;
        ...
        public override float Height => _cursorTexture.Height;
        ...
        public override void Render(Graphics graphics, Camera camera)
        {
            ...
            {
                var node = _trailNodes[i];
                var lerpFactor = i / (float) (_trailNodeCount - 1);

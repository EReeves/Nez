...
namespace Nez
{
	...
	public class Mesh : RenderableComponent
    {
        ...
        private Vector2 _topLeftVertPosition;
        private int[] _triangles;

        private bool _vertexColorEnabled = true;
	    ...
	    public override RectangleF Bounds
        {
            get
            {
                if (AreBoundsDirty)
                {
                    Bounds.CalculateBounds(Entity.Transform.Position + _topLeftVertPosition, Vector2.Zero,
	    ...
	    /// <summary>
	    ///     sets the vert positions. If the positions array does not match the verts array size the verts array will be
	    ///     recreated.
	    /// </summary>
        ...
        {
            Assert.IsTrue(primitiveType == PrimitiveType.TriangleList || primitiveType == PrimitiveType.TriangleStrip,

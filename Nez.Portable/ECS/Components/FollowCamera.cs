...
namespace Nez
{
	...
	public class FollowCamera : Component, IUpdatable
    {
	    ...
	    /// <summary>
	    ///     when in CameraWindow mode the width/height is used as a bounding box to allow movement within it without moving the
	    ///     camera.
	    ///     when in LockOn mode only the deadzone x/y values are used. This is set to sensible defaults when you call follow
	    ///     but you are

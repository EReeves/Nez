...
namespace Nez.Maths
{
    public static class Random
    {
        ...
        public static System.Random Value = new System.Random(_seed);
        ...
        {
            return (float) Value.NextDouble() * max;
        }
        ...
        {
            return (float) Value.NextDouble() * MathHelper.TwoPi;
        }

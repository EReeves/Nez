...
namespace Nez
{
	...
	public class VirtualIntegerAxis : VirtualInput
    {
	    ...
	    public VirtualIntegerAxis AddGamePadLeftStickX(int gamepadIndex = 0, float deadzone = Input.DefaultDeadzone)
        {
	    ...
	    /// <param name="gamepadIndex">Gamepad index.</param>
	    /// <param name="deadzone">Deadzone.</param>
	    public VirtualIntegerAxis AddGamePadLeftStickY(int gamepadIndex = 0, float deadzone = Input.DefaultDeadzone)
        {
	    ...
	    /// <param name="gamepadIndex">Gamepad index.</param>
	    /// <param name="deadzone">Deadzone.</param>
	    public VirtualIntegerAxis AddGamePadRightStickX(int gamepadIndex = 0, float deadzone = Input.DefaultDeadzone)
        {
	    ...
	    /// <param name="gamepadIndex">Gamepad index.</param>
	    /// <param name="deadzone">Deadzone.</param>
	    public VirtualIntegerAxis AddGamePadRightStickY(int gamepadIndex = 0, float deadzone = Input.DefaultDeadzone)
        {

...
namespace Nez.AI.GOAP
{
    ...
    public class AStar
    {
        private static readonly AStarStorage Storage = new AStarStorage();
        ...
        */
	    ...
	    private static Stack<Action> ReconstructPlan(AStarNode goalNode, List<AStarNode> selectedNodes)
        {
	    ...
	    private static int CalculateHeuristic(WorldState fr, WorldState to)
        {

...
namespace Nez.AI.BehaviorTrees
{
    ...
    public enum AbortTypes
    {
	    ...
	    /// <summary>
	    ///     If a more important conditional task changes status it can issue an abort that will stop the lower priority tasks
	    ///     from running
	    ///     and shift control back to the higher priority branch. This type should be set on Composites that are children of
	    ///     the evaulating
	    ...
	    /// <summary>
	    ///     The Conditional task can only abort an Action task if they are both children of the Composite. This AbortType only
	    ///     affects the

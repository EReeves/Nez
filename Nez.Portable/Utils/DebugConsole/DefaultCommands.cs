...
namespace Nez.Utils.DebugConsole
{
    ...
    public partial class DebugConsole
    {
        ...
        private static void InspectEntity(string entityName = "")
        {
            ...
            if (Instance.RuntimeInspector != null)
            {
                Instance.RuntimeInspector.Dispose();
                Instance.RuntimeInspector = null;
            }

            if (entityName == "pp" || entityName == "postprocessors")
            {
                Instance.RuntimeInspector = new RuntimeInspector();
            ...
            else if (entityName != "")
            {
                ...
                Instance.RuntimeInspector = new RuntimeInspector(entity);
                Instance.IsOpen = false;
            }
        }

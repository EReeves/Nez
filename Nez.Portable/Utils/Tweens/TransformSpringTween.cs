...
namespace Nez.Utils.Tweens
{
    public class TransformSpringTween : AbstractTweenable
    {
        ...
        public TransformTargetType TargetType { get; }


	    /// <summary>
	    ///     you can call setTargetValue at any time to reset the target value to a new Vector2. If you have not called start to
	    ///     add the
        ...
        private void SetTweenedValue(Vector2 value)
        {
            switch (TargetType)
            {
        ...
        private Vector2 GetCurrentValueOfTweenedTargetType()
        {
            switch (TargetType)
            {
                case TransformTargetType.Position:

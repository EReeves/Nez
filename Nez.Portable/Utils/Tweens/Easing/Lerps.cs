...
namespace Nez.Utils.Tweens.Easing
{
	...
	public static class Lerps
    {
	    ...
	    /// <summary>
	    ///     A smoothing rate of zero will give you back the target value (i.e. no smoothing), and a rate of 1 is technically
	    ///     not allowed,
	    ///     but will just give you back the source value (i.e. infinite smoothing). Note that this is the opposite of the way a
	    ///     lerp

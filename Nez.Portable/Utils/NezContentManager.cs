...
namespace Nez.Utils
{
    ...
    {
        private readonly Dictionary<string, Effect> _loadedEffects = new Dictionary<string, Effect>();
        ...
        public NezContentManager() : base(((Game) Core.Instance).Services, ((Game) Core.Instance).Content.RootDirectory)
        {
        }
	    ...
	    /// <summary>
	    ///     removes assetName from LoadedAssets and Disposes of it. Note that this method uses reflection to get at the private
	    ///     ContentManager

...
namespace Nez.Utils.Extensions
{
    public static class RectangleExt
    {
	    ...
	    /// <summary>
	    ///     gets a portion of the Rectangle with a width/height of size that is on the Edge of the Rectangle but still
	    ///     contained within it.
	    /// </summary>
        ...
        public static float? RayIntersects(this Rectangle rectangle, Ray ray)
        {
            ...
            {
                var num11 = 1f / ray.Direction.X;
                var num8 = (rectangle.Left - ray.Position.X) * num11;
                var num7 = (rectangle.Right - ray.Position.X) * num11;
                if (num8 > num7)
                {
                    var num14 = num8;
                    num8 = num7;
            ...
            {
                var num10 = 1f / ray.Direction.Y;
                var num6 = (rectangle.Top - ray.Position.Y) * num10;
                var num5 = (rectangle.Bottom - ray.Position.Y) * num10;
                if (num6 > num5)
                {
                    var num13 = num6;
                    num6 = num5;

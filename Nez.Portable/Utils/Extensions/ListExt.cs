...
namespace Nez.Utils.Extensions
{
    public static class ListExt
    {
	    ...
	    /// <summary>
	    ///     gets random items from the list. Does not empty check the list or verify that list count is greater than item
	    ///     count! The returned List can be put back in the pool via ListPool.free.
	    /// </summary>
	    /// <returns>The item.</returns>
	    /// <param name="list">List.</param>

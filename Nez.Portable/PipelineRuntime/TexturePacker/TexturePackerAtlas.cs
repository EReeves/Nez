...
namespace Nez.PipelineRuntime.TexturePacker
{
    public class TexturePackerAtlas
    {
	    ...
	    /// </summary>
	    private readonly Dictionary<string, int> _subtextureMap;
        ...
        public Subtexture this[int index] => GetSubtexture(index);


        public static TexturePackerAtlas Create(Texture2D texture, int regionWidth, int regionHeight,

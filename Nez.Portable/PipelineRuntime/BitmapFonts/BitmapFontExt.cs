...
namespace Nez
{
	...
	public static class BitmapFontExtensions
    {
	    ...
	    public static void DrawString(this SpriteBatch spriteBatch, BitmapFont bitmapFont, string text,
            ...
            float rotation, Vector2 origin, float scale, SpriteEffects effects, float layerDepth)
        {
            ...
            var source = new FontCharacterSource(text);
            bitmapFont.DrawInto(spriteBatch, ref source, position, color, rotation, origin, scaleVec, effects,
                layerDepth);
        }
	    ...
	    /// <param name="position">The drawing location on screen.</param>
	    /// <param name="color">A color mask.</param>
	    public static void DrawString(this SpriteBatch spriteBatch, BitmapFont bitmapFont, StringBuilder text,
            Vector2 position, Color color)
        {
            var source = new FontCharacterSource(text);
            bitmapFont.DrawInto(spriteBatch, ref source, position, color, 0, Vector2.Zero, Vector2.One,

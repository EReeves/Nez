...
namespace Nez.DeferredLighting
{
	...
	///     polygon. A center
	///     vert will be added and used to triangulate the polygon. If you need a transform matrix for the Polygon set the
	///     position/scale and
	...
	public class PolygonMesh : IDisposable
    {
        ...
        private VertexPosition[] GenerateVerts(Vector2[] points)
        {
        ...
        private static Vector2[] BuildSymmetricalPolygon(int vertCount, float radius)
        {

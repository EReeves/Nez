...
namespace Nez.Svg
{
	...
	///     getTransformedPoints method. It uses
	///     System.Drawing to generate the path points from any type of path. The getOptimized*DrawingPoints methods only work
	///     for cubic bezier
	///     curves.
	...
	public class SvgPath : SvgElement
    {
	    ...
	    /// <summary>
	    ///     gets the points that make up the path with any transforms present applied. The points can be used to approximate
	    ///     the path by
	    ///     drawing lines between them.
	    ///     Important notes: ISvgPathBuilder is a faux interface that is required because PCLs cannot access System.Drawing
	    ///     which is used
	    ///     to get the drawing points. In order to use this method you need to put the SvgPathBuilder in your main project and
	    ///     then pass in
	    ...
	    /// <summary>
	    ///     gets optimized drawing points with extra points in curves and less in straight lines. Returns a pooled list that
	    ///     should be returned to the ListPool when done.
	    /// </summary>
	    ...
	    /// <summary>
	    ///     gets optimized drawing points with extra points in curves and less in straight lines with any transforms present
	    ///     applied
	    /// </summary>
	    /// <returns>The optimized drawing points.</returns>
	    /// <param name="distanceTolerance">Distance tolerance.</param>

...
namespace Nez.Graphics.SVG.Shapes.Paths
{
	...
	///     insanely slow way
	///     to build paths since it is stuck using reflection for everything. It is highly recommended that you use the
	...
	public class SvgReflectionPathBuilder : ISvgPathBuilder
    {
	    ...
	    public Vector2[] GetDrawingPoints(List<SvgPathSegment> segments, float flatness = 3)
        {
            ...
            var matrix = Activator.CreateInstance(Type.GetType("System.Drawing.Drawing2D.Matrix, System.Drawing"));

...
namespace Nez.Graphics.PostProcessing
{
	...
	public class PostProcessor : IComparable<PostProcessor>
    {
	    ...
	    /// <summary>
	    ///     called when the default scene RenderTarget is resized. If a PostProcessor is added to a scene before it begins this
	    ///     method will be
	    ///     called before the scene first renders. If the scene already started this will be called after onAddedToScene making
	    ///     it an ideal place
	    ...
	    /// <summary>
	    ///     helper for drawing a texture into the current rendertarget, optionally using a custom shader to apply

...
namespace Nez.UI
{
    public class TooltipManager
    {
        ...
        private readonly List<Tooltip> _shownTooltips = new List<Tooltip>();
	    ...
	    /// <summary>
	    ///     The distance from the tooltip actor position to the edge of the screen where the actor will be shown on the other
	    ///     side of
	    ///     the mouse cursor.
	    /// </summary>
	    ...
	    /// <summary>
	    ///     Seconds from when an actor is hovered to when the tooltip is shown. Call {hideAll() after changing to reset
	    ///     internal state
	    /// </summary>
        ...
        private void StartShowTask(float time)
        {
	    ...
	    /// <summary>
	    ///     Called when tooltip is hidden. Default implementation sets actions to animate hiding and to remove the Element from
	    ///     the stage

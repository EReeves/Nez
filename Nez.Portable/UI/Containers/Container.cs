...
namespace Nez.UI.Containers
{
	...
	public class Container : Group
    {
        ...
        private Value _maxWidthValue = Value.Zero, _maxHeightValue = Value.Zero;
        private Value _minWidthValue = Value.MinWidth, _minHeightValue = Value.MinHeight;
        private Value _padTop = Value.Zero, _padLeft = Value.Zero, _padBottom = Value.Zero, _padRight = Value.Zero;
        private Value _prefWidthValue = Value.PrefWidth, _prefHeightValue = Value.PrefHeight;
        ...
        public override void Layout()
        {
            ...
            var containerWidth = GetWidth() - padLeft - _padRight.Get(this);
            var containerHeight = GetHeight() - padBottom - _padTop.Get(this);
	    ...
	    /// <summary>
	    ///     Sets the alignment of the element within the container. Set to {@link Align#center}, {@link Align#top}, {@link
	    ///     Align#bottom},
        ...
        {
            var v = _maxWidthValue.Get(_element);
            if (v > 0)
        ...
        {
            var v = _maxHeightValue.Get(_element);
            if (v > 0)

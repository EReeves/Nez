namespace Nez.UI.Base
{
	...
	///     this which cascades
	///     down to Checkbox and TextButton. When using the properties you must set shouldUseExplicitFocusableControl to true.
	///     If you want a direction
	///     to not change focus make that direction null. If shouldUseExplicitFocusableControl the Stage will attempt to find
	///     the next focusable
